  ...
  return (
    <>
      ...
      <motion.header 
        ...
        className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 sm:px-6 ${activeNavType === "primary" ? "nav-primary-active" : ""}`}
        style={{ 
      ...
      >
        ...
        <div className="relative z-10 ml-2 sm:ml-0 lg:absolute lg:left-6">
          <Logo />
        </div>
      ...
      <motion.header 
        ...
        className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 sm:px-6 ${activeNavType === "secondary" ? "nav-secondary-active" : ""}`}
        style={{ 
          paddingTop: paddingY, 
