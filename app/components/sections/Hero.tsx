...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Spacer for header */}
      <div className="flex-shrink-0 relative z-10 h-16 sm:h-20 md:h-20" />
      
      <div className="text-center max-w-6xl mx-auto w-full flex-1 flex flex-col justify-center gap-8 sm:gap-12 md:gap-16 lg:gap-20 relative z-10">
        {/* Name and Title */}
        <div className="mb-8 sm:mb-12 md:mb-16 lg:mb-20 xl:mb-24">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-bold text-white uppercase tracking-tight leading-none px-2 !mb-4 sm:!mb-6 md:!mb-8">
            {HERO_CONTENT.name}
          </h1>
      ...
      {/* Bottom spacer */}
      <div className="flex-shrink-0 h-6 sm:h-8 md:h-10" />
      
      {/* Scroll down animation - bottom center */}
      <button
        onClick={() => scrollToSection("expertise")}
        className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2 z-20 cursor-pointer hover:scale-110 transition-transform duration-300"
